...
class Test_Class:
    ...
    def test_class(self):
        ...
        assert _class.professor == "Everson Denis"
    ...
    def test_class_entity_error5(self):
        with pytest.raises(EntityError):
            _class = Class(time(15, 0, 0, 0), time(16, 40, 0, 0), 0,
                           "Ecm407 - redes de ComPutadores", "", "E02", 1, 1, "ECM")

    def test_class_entity_error6(self):
        with pytest.raises(EntityError):
            _class = Class(time(15, 0, 0, 0), time(16, 40, 0, 0), 0,
                           "Ecm407 - redes de ComPutadores", "eVerson Denis", "", 1, 1, "ECM")

    def test_class_entity_error7(self):
        with pytest.raises(EntityError):
            _class = Class(time(15, 0, 0, 0), time(16, 40, 0, 0), 0,
                           "Ecm407 - redes de ComPutadores", "eVerson Denis", "E02", 6, 1, "ECM")
    ...
    def test_class_entity_error9(self):
        with pytest.raises(EntityError):
            _class = Class(time(15, 0, 0, 0), time(16, 40, 0, 0), 0,
                           "Ecm407 - redes de ComPutadores", "eVerson Denis", "E02", 1, 1, "EC")
